...
function Census() {
  ...
  return (
    <div className="lg:h-full min-h-screen bg-black flex justify-center items-center gap-8 flex-col p-[24px]">
      <Analytics />
      ...
      <div className="flex gap-4 flex-col lg:flex-row w-full lg:w-full justify-center">
